...
# experiments/scripts/ is 2 levels under the workspace root (CALIPTRA_WORKSPACE)
WORKSPACE     = SCRIPT_DIR.parents[1]          # caliptra-docker/ = CALIPTRA_WORKSPACE
...
def _fw_objs(test: str, build_dir: Path) -> list[str]:
    ...
    for fb_src in ["c/printf.c", "c/isr.c"]:
        srcs.append(str(FB_ROOT / fb_src))
